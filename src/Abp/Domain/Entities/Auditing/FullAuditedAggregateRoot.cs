...
namespace Abp.Domain.Entities.Auditing
{
    ...
    /// 多数情况(<see cref="int"/>)作为主键类型时，使用<see cref="FullAuditedAggregateRoot{TPrimaryKey}"/> 的快捷方式.
    /// </summary>
    [Serializable]
    ...
    /// 为需要全部审计功能聚合根的接口<see cref="IFullAudited"/>的基类
    /// </summary>
    ...
    /// 为需要全部审计功能聚合根的接口<see cref="IFullAudited{TUser}"/>的基类
    /// </summary>
    /// <typeparam name="TPrimaryKey">Type of the primary key of the entity / 实体的主键类型</typeparam>
        ...
        where TUser : IEntity<long>
    {
        ...
        /// <summary>
        /// Reference to the deleter user of this entity. / 实体删除人的引用
        /// </summary>
