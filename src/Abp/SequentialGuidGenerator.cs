...
namespace Abp
{
    ...
    public class SequentialGuidGenerator : IGuidGenerator
    {
        ...
        /// 获取<see cref="SequentialGuidGenerator"/>单例实例
        /// </summary>
        ...
        /// <summary>
        /// Prevents a default instance of the <see cref="SequentialGuidGenerator"/> class from being created.Use <see cref="Instance"/>.
        /// <see cref="SequentialGuidGenerator"/>类被创建时候防止默认实例。用<see cref="Instance"/>
        /// </summary>
