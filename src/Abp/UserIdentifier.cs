...
namespace Abp
{
    ...
    public class UserIdentifier : IUserIdentifier
    {
        ...
        /// 初始化<see cref="UserIdentifier"/>类新的实例
        /// </summary>
        ...
        /// 初始化<see cref="UserIdentifier"/>类新的实例
        /// </summary>
        /// <param name="tenantId">Tenant Id of the user. / 用户的租户ID</param>
        /// <param name="userId">Id of the user. / 用户ID</param>
